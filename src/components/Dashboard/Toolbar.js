				...
				<ul>
					<li>
						{props.subjectsWindowIsOpen ? (
							<button
								onClick={() =>
									props.setNewSubjectsWindowIsOpen(true)
								}
							>
								New Subject
							</button>
					...
					<li>
						{props.subjectsWindowIsOpen ? (
							<button
								onClick={handleSubjectsWindowButton}
								className={styles.activeButton}
							>
								Subjects
							</button>
						) : (
							<button onClick={handleSubjectsWindowButton}>
								Subjects
							</button>
						)}
					</li>
					...
					<li>
						{props.statsWindowIsOpen ? (
							<button
								onClick={handleStatsWindowButton}
								className={styles.activeButton}
							>
								Stats
							</button>
						) : (
							<button onClick={handleStatsWindowButton}>
								Stats
							</button>
						)}
					</li>
					...
					<li>
						{props.relationsWindowIsOpen ? (
							<button
								onClick={handleRelationsWindowButton}
								className={styles.activeButton}
							>
								Relations
							</button>
						) : (
							<button onClick={handleRelationsWindowButton}>
								Relations
							</button>
						)}
					</li>
